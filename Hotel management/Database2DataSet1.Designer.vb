...
Partial Public Class Database2DataSet1
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal ID As String, ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Address As String, ByVal City As String, ByVal Postcode As String, ByVal Phonenumber As String, ByVal Email As String, ByVal DateofBirth As String) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {ID, Firstname, Lastname, Gender, Address, City, Postcode, Phonenumber, Email, DateofBirth}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByID(ByVal ID As String) As CustomerRow
...
Namespace Database2DataSet1TableAdapters
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([ID] = @Original_ID) AND ((@IsNull_Firstname"& _ 
                ...
                "code)) AND ((@IsNull_Phonenumber = 1 AND [Phonenumber] IS NULL) OR ([Phonenumber"& _ 
                "] = @Original_Phonenumber)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Em"& _ 
                "ail] = @Original_Email)) AND ((@IsNull_DateofBirth = 1 AND [DateofBirth] IS NULL"& _ 
                ") OR ([DateofBirth] = @Original_DateofBirth)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([ID], [Firstname], [Lastname], [Gender], [Address],"& _ 
                " [City], [Postcode], [Phonenumber], [Email], [DateofBirth]) VALUES (@ID, @Firstn"& _ 
                "ame, @Lastname, @Gender, @Address, @City, @Postcode, @Phonenumber, @Email, @Date"& _ 
                "ofBirth);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Firstname, Lastname, Gender, Address, City, Postcode, Phon"& _ 
                "enumber, Email, DateofBirth FROM Customer WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [ID] = @ID, [Firstname] = @Firstname, [Lastname] = @L"& _ 
                "astname, [Gender] = @Gender, [Address] = @Address, [City] = @City, [Postcode] = "& _ 
                "@Postcode, [Phonenumber] = @Phonenumber, [Email] = @Email, [DateofBirth] = @Date"& _ 
                "ofBirth WHERE (([ID] = @Original_ID) AND ((@IsNull_Firstname = 1 AND [Firstname]"& _ 
                " IS NULL) OR ([Firstname] = @Original_Firstname)) AND ((@IsNull_Lastname = 1 AND"& _ 
                " [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Gender "& _ 
                "= 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Addres"& _ 
                "s = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_C"& _ 
                "ity = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Postcode"& _ 
                " = 1 AND [Postcode] IS NULL) OR ([Postcode] = @Original_Postcode)) AND ((@IsNull"& _ 
                "_Phonenumber = 1 AND [Phonenumber] IS NULL) OR ([Phonenumber] = @Original_Phonen"& _ 
                "umber)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Ema"& _ 
                "il)) AND ((@IsNull_DateofBirth = 1 AND [DateofBirth] IS NULL) OR ([DateofBirth] "& _ 
                "= @Original_DateofBirth)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Firstname, Lastname, Gender, Address, Ci"& _ 
                "ty, Postcode, Phonenumber, Email, DateofBirth FROM Customer WHERE (ID = @ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Firstname, Lastname, Gender, Address, City, Postcode, Phonenumber, Ema"& _ 
                "il, DateofBirth FROM dbo.Customer"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database2DataSet1.CustomerDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database2DataSet1.CustomerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database2DataSet1.CustomerDataTable = New Database2DataSet1.CustomerDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database2DataSet1.CustomerDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As String, ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Gender As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Postcode As String, ByVal Original_Phonenumber As String, ByVal Original_Email As String, ByVal Original_DateofBirth As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(18).Value = CType(Original_DateofBirth,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal ID As String, ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Address As String, ByVal City As String, ByVal Postcode As String, ByVal Phonenumber As String, ByVal Email As String, ByVal DateofBirth As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(9).Value = CType(DateofBirth,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(DateofBirth,String)
            End If
            If (Original_ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ID")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_Postcode,String)
            End If
            If (Original_Phonenumber Is Nothing) Then
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Email As String,  _
                    ByVal Original_DateofBirth As String) As Integer
            Return Me.Update(Original_ID, Firstname, Lastname, Gender, Address, City, Postcode, Phonenumber, Email, DateofBirth, Original_ID, Original_Firstname, Original_Lastname, Original_Gender, Original_Address, Original_City, Original_Postcode, Original_Phonenumber, Original_Email, Original_DateofBirth)
        End Function
    End Class
