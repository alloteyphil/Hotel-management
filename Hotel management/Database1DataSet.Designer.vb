...
Partial Public Class Database1DataSet
    ...
    Partial Public Class RegisterDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddRegisterRow(ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Phonenumber As String, ByVal Username As String, ByVal Password As String) As RegisterRow
            Dim rowRegisterRow As RegisterRow = CType(Me.NewRow,RegisterRow)
            Dim columnValuesArray() As Object = New Object() {Firstname, Lastname, Gender, Phonenumber, Username, Password}
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class RegisterTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Register] WHERE (([Firstname] = @Original_Firstname) AND ([Las"& _ 
                "tname] = @Original_Lastname) AND ([Gender] = @Original_Gender) AND ([Phonenumber"& _ 
                "] = @Original_Phonenumber) AND ([Username] = @Original_Username) AND ([Password]"& _ 
                " = @Original_Password))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Register] ([Firstname], [Lastname], [Gender], [Phonenumber], ["& _ 
                "Username], [Password]) VALUES (@Firstname, @Lastname, @Gender, @Phonenumber, @Us"& _ 
                "ername, @Password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Firstname, Lastname, Gender, Phonenumber, Username, "& _ 
                "Password FROM Register WHERE (Username = @Username)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Register] SET [Firstname] = @Firstname, [Lastname] = @Lastname, [Ge"& _ 
                "nder] = @Gender, [Phonenumber] = @Phonenumber, [Username] = @Username, [Password"& _ 
                "] = @Password WHERE (([Firstname] = @Original_Firstname) AND ([Lastname] = @Orig"& _ 
                "inal_Lastname) AND ([Gender] = @Original_Gender) AND ([Phonenumber] = @Original_"& _ 
                "Phonenumber) AND ([Username] = @Original_Username) AND ([Password] = @Original_P"& _ 
                "assword));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Firstname, Lastname, Gender, Phonenumber, Username, Password "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Hotel_management.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Firstname, Lastname, Gender, Phonenumber, Username, Password FROM dbo.Regi"& _ 
                "ster"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Gender As String, ByVal Original_Phonenumber As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Phonenumber As String, ByVal Username As String, ByVal Password As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Phonenumber As String, ByVal Username As String, ByVal Password As String, ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Gender As String, ByVal Original_Phonenumber As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            If (Firstname Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Firstname")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Firstname As String, ByVal Lastname As String, ByVal Gender As String, ByVal Phonenumber As String, ByVal Password As String, ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Gender As String, ByVal Original_Phonenumber As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            Return Me.Update(Firstname, Lastname, Gender, Phonenumber, Original_Username, Password, Original_Firstname, Original_Lastname, Original_Gender, Original_Phonenumber, Original_Username, Original_Password)
        End Function
    End Class
